...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\DDH\ZmenaNaSlovnaftRepository")
 * @ORM\Table(name="DDH_HV_ZmenaNaSlovnaft", schema="Dispecing")
 */
class ZmenaNaSlovnaft extends BaseEntity
{
    /**
     * @ORM\Id
