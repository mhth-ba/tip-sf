...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\DDH\ZmenaNaCWRepository")
 * @ORM\Table(name="DDH_HV_ZmenaNaCW", schema="Dispecing")
 */
class ZmenaNaCW extends BaseEntity
{
    /**
     * @ORM\Id
