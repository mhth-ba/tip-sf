...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\DDH\ZmenaNaHVVychodRepository")
 * @ORM\Table(name="DDH_HV_ZmenaNaHV_Vychod", schema="Dispecing")
 */
class ZmenaNaHVVychod extends BaseEntity
{
    /**
     * @ORM\Id
