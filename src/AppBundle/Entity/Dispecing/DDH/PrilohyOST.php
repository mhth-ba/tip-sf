...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\DDH\PrilohyOSTRepository")
 * @ORM\Table(name="DDH_OST_Prilohy", schema="Dispecing")
 */
class PrilohyOST extends BaseEntity
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\Dispecing\DDH\HlavnyOST")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\App\User")
     * @ORM\JoinColumn(name="nahral_id")
     */
    private $nahral;
