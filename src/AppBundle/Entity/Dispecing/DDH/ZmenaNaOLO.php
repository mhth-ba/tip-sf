...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\DDH\ZmenaNaOLORepository")
 * @ORM\Table(name="DDH_HV_ZmenaNaOLO", schema="Dispecing")
 */
class ZmenaNaOLO extends BaseEntity
{
    /**
     * @ORM\Id
