...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\DDH\ZmenaNaTpZRepository")
 * @ORM\Table(name="DDH_HV_ZmenaNaTpZ", schema="Dispecing")
 */
class ZmenaNaTpZ extends BaseEntity
{
    /**
     * @ORM\Id
