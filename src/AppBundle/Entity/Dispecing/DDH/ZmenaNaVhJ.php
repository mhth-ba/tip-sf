...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\DDH\ZmenaNaVhJRepository")
 * @ORM\Table(name="DDH_HV_ZmenaNaVhJ", schema="Dispecing")
 */
class ZmenaNaVhJ extends BaseEntity
{
    /**
     * @ORM\Id
