...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\DDH\ZmenaNaPPCRepository")
 * @ORM\Table(name="DDH_HV_ZmenaNaPPC", schema="Dispecing")
 */
class ZmenaNaPPC extends BaseEntity
{
    /**
     * @ORM\Id
