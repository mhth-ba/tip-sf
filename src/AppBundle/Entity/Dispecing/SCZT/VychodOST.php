...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\SCZT\VychodOSTRepository")
 * @ORM\Table(name="SCZTV_OST", schema="Dispecing")
 */
class VychodOST extends BaseEntity
{
    /**
     * @ORM\Id
