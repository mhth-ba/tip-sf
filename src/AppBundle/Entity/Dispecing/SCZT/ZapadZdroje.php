...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\SCZT\ZapadZdrojeRepository")
 * @ORM\Table(name="SCZTZ_Zdroje", schema="Dispecing")
 */
class ZapadZdroje extends BaseEntity
{
    /**
     * @ORM\Id
