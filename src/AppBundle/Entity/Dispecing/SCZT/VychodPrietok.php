...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\SCZT\VychodPrietokRepository")
 * @ORM\Table(name="SCZTV_Prietok", schema="Dispecing")
 */
class VychodPrietok extends BaseEntity
{
    /**
     * @ORM\Id
