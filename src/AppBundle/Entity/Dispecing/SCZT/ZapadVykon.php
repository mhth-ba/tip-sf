...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Dispecing\SCZT\ZapadVykonRepository")
 * @ORM\Table(name="SCZTZ_Vykon", schema="Dispecing")
 */
class ZapadVykon extends BaseEntity
{
    /**
     * @ORM\Id
