...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Uctovnictvo\DP\DanoveDokladyRepository")
 * @ORM\Table(name="DP_DanoveDoklady", schema="Uctovnictvo")
 */
class DanoveDoklady extends BaseEntity
{
    /**
     * @ORM\Id
