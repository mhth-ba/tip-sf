...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Uctovnictvo\DP\Vystup_ZRepository")
 * @ORM\Table(name="DP_Vystup_Z", schema="Uctovnictvo")
 */
class Vystup_Z extends BaseEntity
{
    /**
     * @ORM\Id
