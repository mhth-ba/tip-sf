...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Kontroling\VCT\OcakavaneNakladyRepository")
 * @ORM\Table(name="VCT_OcakavaneNaklady", schema="Kontroling")
 */
class OcakavaneNaklady extends BaseEntity
{
    /**
     * @ORM\Id
