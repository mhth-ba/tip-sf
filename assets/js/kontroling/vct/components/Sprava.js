...
class Sprava extends React.Component {
  ...
  render() {
    ...
    return (
      <Card>
        <CardHeader>
          {/* Karta správy prístupov, prehľadu aktivity užívateľov */}
        ...
        <CardBody>
          <TabContent activeTab={ this.state.activeTab }>
            ...
            { opravnenia.mng ?
              hlavny.initialized ?
                <div>
                  Prehľad histórie zadaných hodnôt k aktuálne otvorenému záznamu vyhodnotenia ceny tepla...
                  <br/><br/>
                  Zobraziť prehľad zadaných hodnôt vo <u>všetkých</u> záznamoch vyhodnotenia ceny tepla ?
                </div>
                :
                <div>
                  Prehľad zadaných hodnôt užívateľmi vo všetkých záznamoch vyhodnotenia ceny tepla
                </div>
              :
              <span>...</span>
            }
