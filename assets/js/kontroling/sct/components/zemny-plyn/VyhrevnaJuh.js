      ...
      <Card>
        ...
        <CardBody>
          <Table size={'sm'} bordered>
            ...
            <tr className="text-right">
              <th id={'vhj-pc'} className="text-left">Priemerná cena</th>
              <UncontrolledTooltip target={'vhj-pc'}>Vrátane PDM</UncontrolledTooltip>
              <Vypocet value={ cena.objem_m3 }
                       ...
                       cellsId={['fzp_j_spo_ns', 'fzp_j_spo_m3']}
                       placement={'bottom'}
                       decimal={4}
              ...
              <Vypocet value={ cena.objem_mwh }
                       ...
                       cellsId={['fzp_j_spo_ns', 'fzp_j_spo_mwh']}
                       placement={'bottom'}
                       decimal={4}
            ...
            <tr className="text-right">
              ...
              <Vypocet value={ vn }
                       ...
                       popoverId={'fzp_j_vn_pop'}
                       cellsId={['fzp_j_spo_sopo', 'fzp_j_spo_sopp', 'fzp_j_spo_sopd', 'fzp_j_spo_dan_e', 'fzp_j_spo_pdm']}
                       placement={'right'}
                       decimal={decimal}
            ...
            <tr className="text-right">
              ...
              <Vypocet value={ fn }
                       ...
                       popoverId={'fzp_j_fn_pop'}
                       cellsId={['fzp_j_spo_fmso', 'fzp_j_spo_fmsp', 'fzp_j_spo_fmsd', 'fzp_j_spo_vsd']}
                       placement={'right'}
                       decimal={decimal}
                       class={'font-weight-bold'}
              />
