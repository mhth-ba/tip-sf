...
class TeplarenVychod extends React.Component {
  ...
  render() {
    ...
    const decimal = this.props.nastroje.decimal_fzptpv
    ...
    const {
      fzp_v_jan_m3, fzp_v_jan_mwh, fzp_v_jan_sopo, fzp_v_jan_fmso, fzp_v_jan_sopp, fzp_v_jan_fmsp,
      fzp_v_jan_sopd, fzp_v_jan_fmsd, fzp_v_jan_vsd, fzp_v_jan_dan_mwh, fzp_v_jan_dan_e, fzp_v_jan_pdm, fzp_v_jan_ns,

      fzp_v_feb_m3, fzp_v_feb_mwh, fzp_v_feb_sopo, fzp_v_feb_fmso, fzp_v_feb_sopp, fzp_v_feb_fmsp,
      fzp_v_feb_sopd, fzp_v_feb_fmsd, fzp_v_feb_vsd, fzp_v_feb_dan_mwh, fzp_v_feb_dan_e, fzp_v_feb_pdm, fzp_v_feb_ns,

      fzp_v_mar_m3, fzp_v_mar_mwh, fzp_v_mar_sopo, fzp_v_mar_fmso, fzp_v_mar_sopp, fzp_v_mar_fmsp,
      fzp_v_mar_sopd, fzp_v_mar_fmsd, fzp_v_mar_vsd, fzp_v_mar_dan_mwh, fzp_v_mar_dan_e, fzp_v_mar_pdm, fzp_v_mar_ns,

      fzp_v_apr_m3, fzp_v_apr_mwh, fzp_v_apr_sopo, fzp_v_apr_fmso, fzp_v_apr_sopp, fzp_v_apr_fmsp,
      fzp_v_apr_sopd, fzp_v_apr_fmsd, fzp_v_apr_vsd, fzp_v_apr_dan_mwh, fzp_v_apr_dan_e, fzp_v_apr_pdm, fzp_v_apr_ns,

      fzp_v_maj_m3, fzp_v_maj_mwh, fzp_v_maj_sopo, fzp_v_maj_fmso, fzp_v_maj_sopp, fzp_v_maj_fmsp,
      fzp_v_maj_sopd, fzp_v_maj_fmsd, fzp_v_maj_vsd, fzp_v_maj_dan_mwh, fzp_v_maj_dan_e, fzp_v_maj_pdm, fzp_v_maj_ns,

      fzp_v_jun_m3, fzp_v_jun_mwh, fzp_v_jun_sopo, fzp_v_jun_fmso, fzp_v_jun_sopp, fzp_v_jun_fmsp,
      fzp_v_jun_sopd, fzp_v_jun_fmsd, fzp_v_jun_vsd, fzp_v_jun_dan_mwh, fzp_v_jun_dan_e, fzp_v_jun_pdm, fzp_v_jun_ns,

      fzp_v_jul_m3, fzp_v_jul_mwh, fzp_v_jul_sopo, fzp_v_jul_fmso, fzp_v_jul_sopp, fzp_v_jul_fmsp,
      fzp_v_jul_sopd, fzp_v_jul_fmsd, fzp_v_jul_vsd, fzp_v_jul_dan_mwh, fzp_v_jul_dan_e, fzp_v_jul_pdm, fzp_v_jul_ns,

      fzp_v_aug_m3, fzp_v_aug_mwh, fzp_v_aug_sopo, fzp_v_aug_fmso, fzp_v_aug_sopp, fzp_v_aug_fmsp,
      fzp_v_aug_sopd, fzp_v_aug_fmsd, fzp_v_aug_vsd, fzp_v_aug_dan_mwh, fzp_v_aug_dan_e, fzp_v_aug_pdm, fzp_v_aug_ns,

      fzp_v_sep_m3, fzp_v_sep_mwh, fzp_v_sep_sopo, fzp_v_sep_fmso, fzp_v_sep_sopp, fzp_v_sep_fmsp,
      fzp_v_sep_sopd, fzp_v_sep_fmsd, fzp_v_sep_vsd, fzp_v_sep_dan_mwh, fzp_v_sep_dan_e, fzp_v_sep_pdm, fzp_v_sep_ns,

      fzp_v_okt_m3, fzp_v_okt_mwh, fzp_v_okt_sopo, fzp_v_okt_fmso, fzp_v_okt_sopp, fzp_v_okt_fmsp,
      fzp_v_okt_sopd, fzp_v_okt_fmsd, fzp_v_okt_vsd, fzp_v_okt_dan_mwh, fzp_v_okt_dan_e, fzp_v_okt_pdm, fzp_v_okt_ns,

      fzp_v_nov_m3, fzp_v_nov_mwh, fzp_v_nov_sopo, fzp_v_nov_fmso, fzp_v_nov_sopp, fzp_v_nov_fmsp,
      fzp_v_nov_sopd, fzp_v_nov_fmsd, fzp_v_nov_vsd, fzp_v_nov_dan_mwh, fzp_v_nov_dan_e, fzp_v_nov_pdm, fzp_v_nov_ns,

      fzp_v_dec_m3, fzp_v_dec_mwh, fzp_v_dec_sopo, fzp_v_dec_fmso, fzp_v_dec_sopp, fzp_v_dec_fmsp,
      fzp_v_dec_sopd, fzp_v_dec_fmsd, fzp_v_dec_vsd, fzp_v_dec_dan_mwh, fzp_v_dec_dan_e, fzp_v_dec_pdm, fzp_v_dec_ns,

      fzp_v_spo_m3, fzp_v_spo_mwh, fzp_v_spo_sopo, fzp_v_spo_fmso, fzp_v_spo_sopp, fzp_v_spo_fmsp,
      fzp_v_spo_sopd, fzp_v_spo_fmsd, fzp_v_spo_vsd, fzp_v_spo_dan_mwh, fzp_v_spo_dan_e, fzp_v_spo_pdm, fzp_v_spo_ns,
    ...
    return (
      <Card>
        <CardHeader className="bg-primary text-white">Tepláreň Východ</CardHeader>
        <CardBody>
          <Table size={'sm'} bordered>
            ...
            <tr className="text-center">
              ...
              <th rowSpan={2} style={{ maxWidth: '80px' }} id={'tpv-pdm'}>PDM <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpv-pdm'}>Prekročenie dohodnutých množstiev</UncontrolledTooltip>
              <th rowSpan={2}>Náklady spolu <Jednotka unit={'€'} /></th>
            </tr>
            <tr className="text-center">
              <th id={'tpv-sopo'}>SOP<sub>o</sub> <Jednotka unit={'€'} /></th>
              ...
              <th id={'tpv-sopp'}>SOP<sub>p</sub> <Jednotka unit={'€'} /></th>
              ...
              <th id={'tpv-sopd'}>SOP<sub>d</sub> <Jednotka unit={'€'} /></th>
              ...
              <th id={'tpv-vsd'}>VS<sub>d</sub> <Jednotka unit={'€'} /></th>
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_jan} val={januar.objem_m3} col={'objem_m3'} class={fzp_v_jan_m3} />
              <Vstup {...vstup_jan} val={januar.objem_mwh} col={'objem_mwh'} class={fzp_v_jan_mwh} />
              <Vypocet value={ januar.sopo }
                       cisla={ <div>
                         <NumberFormat {...vypocetFormat} value={januar.objem_mwh} />
                         &nbsp;×&nbsp;
                         <NumberFormat {...vypocetFormat} value={jczpsopov.hodnota} decimalScale={5} />
                       </div> }
                       popis={ <div>
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jan_sopo}
              />
              <Vstup {...vstup_jan} val={januar.fmso} col={'fmso'} class={fzp_v_jan_fmso} />
              <Vypocet value={ januar.sopp }
                       cisla={ <div>
                         <NumberFormat {...vypocetFormat} value={januar.objem_mwh} />
                         &nbsp;×&nbsp;
                         <NumberFormat {...vypocetFormat} value={jczpsoppv.hodnota} decimalScale={5} />
                       </div> }
                       popis={ <div>
                         <span className="polozka-1">MWh</span>
                         &nbsp;×&nbsp;
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jan_sopp}
              />
              <Vstup {...vstup_jan} val={januar.fmsp} col={'fmsp'} class={fzp_v_jan_fmsp} />
              <Vypocet value={ januar.sopd }
                       cisla={ <div>
                         <NumberFormat {...vypocetFormat} value={januar.objem_mwh} />
                         &nbsp;×&nbsp;
                         <NumberFormat {...vypocetFormat} value={jczpsopdv.hodnota} decimalScale={5} />
                       </div> }
                       popis={ <div>
                         <span className="polozka-1">MWh</span>
                         &nbsp;×&nbsp;
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jan_sopd}
              />
              <Vstup {...vstup_jan} val={januar.fmsd} col={'fmsd'} class={fzp_v_jan_fmsd} />
              <Vstup {...vstup_jan} val={januar.vsd} col={'vsd'} class={fzp_v_jan_vsd} />
              <Vstup {...vstup_jan} val={januar.dan_mwh} col={'dan_mwh'} class={fzp_v_jan_dan_mwh} />
              <Vstup {...vstup_jan} val={januar.dan_eur} col={'dan_eur'} class={fzp_v_jan_dan_e} />
              <Vstup {...vstup_jan} val={januar.pdm} col={'pdm'} class={fzp_v_jan_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_feb} val={februar.objem_m3} col={'objem_m3'} class={fzp_v_feb_m3} />
              <Vstup {...vstup_feb} val={februar.objem_mwh} col={'objem_mwh'} class={fzp_v_feb_mwh} />
              <Vypocet value={ februar.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_feb_sopo}
              />
              <Vstup {...vstup_feb} val={februar.fmso} col={'fmso'} class={fzp_v_feb_fmso} />
              <Vypocet value={ februar.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_feb_sopp}
              />
              <Vstup {...vstup_feb} val={februar.fmsp} col={'fmsp'} class={fzp_v_feb_fmsp} />
              <Vypocet value={ februar.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_feb_sopd}
              />
              <Vstup {...vstup_feb} val={februar.fmsd} col={'fmsd'} class={fzp_v_feb_fmsd} />
              <Vstup {...vstup_feb} val={februar.vsd} col={'vsd'} class={fzp_v_feb_vsd} />
              <Vstup {...vstup_feb} val={februar.dan_mwh} col={'dan_mwh'} class={fzp_v_feb_dan_mwh} />
              <Vstup {...vstup_feb} val={februar.dan_eur} col={'dan_eur'} class={fzp_v_feb_dan_e} />
              <Vstup {...vstup_feb} val={februar.pdm} col={'pdm'} class={fzp_v_feb_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_mar} val={marec.objem_m3} col={'objem_m3'} class={fzp_v_mar_m3} />
              <Vstup {...vstup_mar} val={marec.objem_mwh} col={'objem_mwh'} class={fzp_v_mar_mwh} />
              <Vypocet value={ marec.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_mar_sopo}
              />
              <Vstup {...vstup_mar} val={marec.fmso} col={'fmso'} class={fzp_v_mar_fmso} />
              <Vypocet value={ marec.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_mar_sopp}
              />
              <Vstup {...vstup_mar} val={marec.fmsp} col={'fmsp'} class={fzp_v_mar_fmsp} />
              <Vypocet value={ marec.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_mar_sopd}
              />
              <Vstup {...vstup_mar} val={marec.fmsd} col={'fmsd'} class={fzp_v_mar_fmsd} />
              <Vstup {...vstup_mar} val={marec.vsd} col={'vsd'} class={fzp_v_mar_vsd} />
              <Vstup {...vstup_mar} val={marec.dan_mwh} col={'dan_mwh'} class={fzp_v_mar_dan_mwh} />
              <Vstup {...vstup_mar} val={marec.dan_eur} col={'dan_eur'} class={fzp_v_mar_dan_e} />
              <Vstup {...vstup_mar} val={marec.pdm} col={'pdm'} class={fzp_v_mar_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_apr} val={april.objem_m3} col={'objem_m3'} class={fzp_v_apr_m3} />
              <Vstup {...vstup_apr} val={april.objem_mwh} col={'objem_mwh'} class={fzp_v_apr_mwh} />
              <Vypocet value={ april.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_apr_sopo}
              />
              <Vstup {...vstup_apr} val={april.fmso} col={'fmso'} class={fzp_v_apr_fmso} />
              <Vypocet value={ april.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_apr_sopp}
              />
              <Vstup {...vstup_apr} val={april.fmsp} col={'fmsp'} class={fzp_v_apr_fmsp} />
              <Vypocet value={ april.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_apr_sopd}
              />
              <Vstup {...vstup_apr} val={april.fmsd} col={'fmsd'} class={fzp_v_apr_fmsd} />
              <Vstup {...vstup_apr} val={april.vsd} col={'vsd'} class={fzp_v_apr_vsd} />
              <Vstup {...vstup_apr} val={april.dan_mwh} col={'dan_mwh'} class={fzp_v_apr_dan_mwh} />
              <Vstup {...vstup_apr} val={april.dan_eur} col={'dan_eur'} class={fzp_v_apr_dan_e} />
              <Vstup {...vstup_apr} val={april.pdm} col={'pdm'} class={fzp_v_apr_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_maj} val={maj.objem_m3} col={'objem_m3'} class={fzp_v_maj_m3} />
              <Vstup {...vstup_maj} val={maj.objem_mwh} col={'objem_mwh'} class={fzp_v_maj_mwh} />
              <Vypocet value={ maj.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_maj_sopo}
              />
              <Vstup {...vstup_maj} val={maj.fmso} col={'fmso'} class={fzp_v_maj_fmso} />
              <Vypocet value={ maj.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_maj_sopp}
              />
              <Vstup {...vstup_maj} val={maj.fmsp} col={'fmsp'} class={fzp_v_maj_fmsp} />
              <Vypocet value={ maj.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_maj_sopd}
              />
              <Vstup {...vstup_maj} val={maj.fmsd} col={'fmsd'} class={fzp_v_maj_fmsd} />
              <Vstup {...vstup_maj} val={maj.vsd} col={'vsd'} class={fzp_v_maj_vsd} />
              <Vstup {...vstup_maj} val={maj.dan_mwh} col={'dan_mwh'} class={fzp_v_maj_dan_mwh} />
              <Vstup {...vstup_maj} val={maj.dan_eur} col={'dan_eur'} class={fzp_v_maj_dan_e} />
              <Vstup {...vstup_maj} val={maj.pdm} col={'pdm'} class={fzp_v_maj_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_jun} val={jun.objem_m3} col={'objem_m3'} class={fzp_v_jun_m3} />
              <Vstup {...vstup_jun} val={jun.objem_mwh} col={'objem_mwh'} class={fzp_v_jun_mwh} />
              <Vypocet value={ jun.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jun_sopo}
              />
              <Vstup {...vstup_jun} val={jun.fmso} col={'fmso'} class={fzp_v_jun_fmso} />
              <Vypocet value={ jun.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jun_sopp}
              />
              <Vstup {...vstup_jun} val={jun.fmsp} col={'fmsp'} class={fzp_v_jun_fmsp} />
              <Vypocet value={ jun.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jun_sopd}
              />
              <Vstup {...vstup_jun} val={jun.fmsd} col={'fmsd'} class={fzp_v_jun_fmsd} />
              <Vstup {...vstup_jun} val={jun.vsd} col={'vsd'} class={fzp_v_jun_vsd} />
              <Vstup {...vstup_jun} val={jun.dan_mwh} col={'dan_mwh'} class={fzp_v_jun_dan_mwh} />
              <Vstup {...vstup_jun} val={jun.dan_eur} col={'dan_eur'} class={fzp_v_jun_dan_e} />
              <Vstup {...vstup_jun} val={jun.pdm} col={'pdm'} class={fzp_v_jun_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_jul} val={jul.objem_m3} col={'objem_m3'} class={fzp_v_jul_m3} />
              <Vstup {...vstup_jul} val={jul.objem_mwh} col={'objem_mwh'} class={fzp_v_jul_mwh} />
              <Vypocet value={ jul.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jul_sopo}
              />
              <Vstup {...vstup_jul} val={jul.fmso} col={'fmso'} class={fzp_v_jul_fmso} />
              <Vypocet value={ jul.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jul_sopp}
              />
              <Vstup {...vstup_jul} val={jul.fmsp} col={'fmsp'} class={fzp_v_jul_fmsp} />
              <Vypocet value={ jul.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_jul_sopd}
              />
              <Vstup {...vstup_jul} val={jul.fmsd} col={'fmsd'} class={fzp_v_jul_fmsd} />
              <Vstup {...vstup_jul} val={jul.vsd} col={'vsd'} class={fzp_v_jul_vsd} />
              <Vstup {...vstup_jul} val={jul.dan_mwh} col={'dan_mwh'} class={fzp_v_jul_dan_mwh} />
              <Vstup {...vstup_jul} val={jul.dan_eur} col={'dan_eur'} class={fzp_v_jul_dan_e} />
              <Vstup {...vstup_jul} val={jul.pdm} col={'pdm'} class={fzp_v_jul_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_aug} val={august.objem_m3} col={'objem_m3'} class={fzp_v_aug_m3} />
              <Vstup {...vstup_aug} val={august.objem_mwh} col={'objem_mwh'} class={fzp_v_aug_mwh} />
              <Vypocet value={ august.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_aug_sopo}
              />
              <Vstup {...vstup_aug} val={august.fmso} col={'fmso'} class={fzp_v_aug_fmso} />
              <Vypocet value={ august.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_aug_sopp}
              />
              <Vstup {...vstup_aug} val={august.fmsp} col={'fmsp'} class={fzp_v_aug_fmsp} />
              <Vypocet value={ august.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_aug_sopd}
              />
              <Vstup {...vstup_aug} val={august.fmsd} col={'fmsd'} class={fzp_v_aug_fmsd} />
              <Vstup {...vstup_aug} val={august.vsd} col={'vsd'} class={fzp_v_aug_vsd} />
              <Vstup {...vstup_aug} val={august.dan_mwh} col={'dan_mwh'} class={fzp_v_aug_dan_mwh} />
              <Vstup {...vstup_aug} val={august.dan_eur} col={'dan_eur'} class={fzp_v_aug_dan_e} />
              <Vstup {...vstup_aug} val={august.pdm} col={'pdm'} class={fzp_v_aug_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_sep} val={september.objem_m3} col={'objem_m3'} class={fzp_v_sep_m3} />
              <Vstup {...vstup_sep} val={september.objem_mwh} col={'objem_mwh'} class={fzp_v_sep_mwh} />
              <Vypocet value={ september.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_sep_sopo}
              />
              <Vstup {...vstup_sep} val={september.fmso} col={'fmso'} class={fzp_v_sep_fmso} />
              <Vypocet value={ september.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_sep_sopp}
              />
              <Vstup {...vstup_sep} val={september.fmsp} col={'fmsp'} class={fzp_v_sep_fmsp} />
              <Vypocet value={ september.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_sep_sopd}
              />
              <Vstup {...vstup_sep} val={september.fmsd} col={'fmsd'} class={fzp_v_sep_fmsd} />
              <Vstup {...vstup_sep} val={september.vsd} col={'vsd'} class={fzp_v_sep_vsd} />
              <Vstup {...vstup_sep} val={september.dan_mwh} col={'dan_mwh'} class={fzp_v_sep_dan_mwh} />
              <Vstup {...vstup_sep} val={september.dan_eur} col={'dan_eur'} class={fzp_v_sep_dan_e} />
              <Vstup {...vstup_sep} val={september.pdm} col={'pdm'} class={fzp_v_sep_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_okt} val={oktober.objem_m3} col={'objem_m3'} class={fzp_v_okt_m3} />
              <Vstup {...vstup_okt} val={oktober.objem_mwh} col={'objem_mwh'} class={fzp_v_okt_mwh} />
              <Vypocet value={ oktober.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_okt_sopo}
              />
              <Vstup {...vstup_okt} val={oktober.fmso} col={'fmso'} class={fzp_v_okt_fmso} />
              <Vypocet value={ oktober.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_okt_sopp}
              />
              <Vstup {...vstup_okt} val={oktober.fmsp} col={'fmsp'} class={fzp_v_okt_fmsp} />
              <Vypocet value={ oktober.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_okt_sopd}
              />
              <Vstup {...vstup_okt} val={oktober.fmsd} col={'fmsd'} class={fzp_v_okt_fmsd} />
              <Vstup {...vstup_okt} val={oktober.vsd} col={'vsd'} class={fzp_v_okt_vsd} />
              <Vstup {...vstup_okt} val={oktober.dan_mwh} col={'dan_mwh'} class={fzp_v_okt_dan_mwh} />
              <Vstup {...vstup_okt} val={oktober.dan_eur} col={'dan_eur'} class={fzp_v_okt_dan_e} />
              <Vstup {...vstup_okt} val={oktober.pdm} col={'pdm'} class={fzp_v_okt_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_nov} val={november.objem_m3} col={'objem_m3'} class={fzp_v_nov_m3} />
              <Vstup {...vstup_nov} val={november.objem_mwh} col={'objem_mwh'} class={fzp_v_nov_mwh} />
              <Vypocet value={ november.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_nov_sopo}
              />
              <Vstup {...vstup_nov} val={november.fmso} col={'fmso'} class={fzp_v_nov_fmso} />
              <Vypocet value={ november.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_nov_sopp}
              />
              <Vstup {...vstup_nov} val={november.fmsp} col={'fmsp'} class={fzp_v_nov_fmsp} />
              <Vypocet value={ november.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_nov_sopd}
              />
              <Vstup {...vstup_nov} val={november.fmsd} col={'fmsd'} class={fzp_v_nov_fmsd} />
              <Vstup {...vstup_nov} val={november.vsd} col={'vsd'} class={fzp_v_nov_vsd} />
              <Vstup {...vstup_nov} val={november.dan_mwh} col={'dan_mwh'} class={fzp_v_nov_dan_mwh} />
              <Vstup {...vstup_nov} val={november.dan_eur} col={'dan_eur'} class={fzp_v_nov_dan_e} />
              <Vstup {...vstup_nov} val={november.pdm} col={'pdm'} class={fzp_v_nov_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_dec} val={december.objem_m3} col={'objem_m3'} class={fzp_v_dec_m3} />
              <Vstup {...vstup_dec} val={december.objem_mwh} col={'objem_mwh'} class={fzp_v_dec_mwh} />
              <Vypocet value={ december.sopo }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_dec_sopo}
              />
              <Vstup {...vstup_dec} val={december.fmso} col={'fmso'} class={fzp_v_dec_fmso} />
              <Vypocet value={ december.sopp }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_dec_sopp}
              />
              <Vstup {...vstup_dec} val={december.fmsp} col={'fmsp'} class={fzp_v_dec_fmsp} />
              <Vypocet value={ december.sopd }
                       ...
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_v_dec_sopd}
              />
              <Vstup {...vstup_dec} val={december.fmsd} col={'fmsd'} class={fzp_v_dec_fmsd} />
              <Vstup {...vstup_dec} val={december.vsd} col={'vsd'} class={fzp_v_dec_vsd} />
              <Vstup {...vstup_dec} val={december.dan_mwh} col={'dan_mwh'} class={fzp_v_dec_dan_mwh} />
              <Vstup {...vstup_dec} val={december.dan_eur} col={'dan_eur'} class={fzp_v_dec_dan_e} />
              <Vstup {...vstup_dec} val={december.pdm} col={'pdm'} class={fzp_v_dec_pdm} />
            ...
            <tr className="text-right">
              ...
              <Vypocet value={ spolu.objem_m3 }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_m3', 'fzp_v_okt_m3', 'fzp_v_nov_m3', 'fzp_v_dec_m3']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_m3 + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.objem_mwh }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_mwh', 'fzp_v_okt_mwh', 'fzp_v_nov_mwh', 'fzp_v_dec_mwh']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_mwh + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.sopo }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_sopo', 'fzp_v_okt_sopo', 'fzp_v_nov_sopo', 'fzp_v_dec_sopo']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_sopo + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.fmso }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_fmso', 'fzp_v_okt_fmso', 'fzp_v_nov_fmso', 'fzp_v_dec_fmso']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_fmso + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.sopp }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_sopp', 'fzp_v_okt_sopp', 'fzp_v_nov_sopp', 'fzp_v_dec_sopp']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_sopp + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.fmsp }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_fmsp', 'fzp_v_okt_fmsp', 'fzp_v_nov_fmsp', 'fzp_v_dec_fmsp']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_fmsp + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.sopd }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_sopd', 'fzp_v_okt_sopd', 'fzp_v_nov_sopd', 'fzp_v_dec_sopd']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_sopd + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.fmsd }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_fmsd', 'fzp_v_okt_fmsd', 'fzp_v_nov_fmsd', 'fzp_v_dec_fmsd']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_fmsd + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.vsd }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_vsd', 'fzp_v_okt_vsd', 'fzp_v_nov_vsd', 'fzp_v_dec_vsd']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_vsd + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.dan_mwh }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_dan_mwh', 'fzp_v_okt_dan_mwh', 'fzp_v_nov_dan_mwh', 'fzp_v_dec_dan_mwh']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_dan_mwh + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.dan_eur }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_dan_e', 'fzp_v_okt_dan_e', 'fzp_v_nov_dan_e', 'fzp_v_dec_dan_e']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_dan_e + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.pdm }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_pdm', 'fzp_v_okt_pdm', 'fzp_v_nov_pdm', 'fzp_v_dec_pdm']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_pdm + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.naklady }
                       ...
                       cellsId={[
                         ...
                         'fzp_v_sep_ns', 'fzp_v_okt_ns', 'fzp_v_nov_ns', 'fzp_v_dec_ns']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_v_spo_ns + ' font-weight-bold'}
              />
            </tr>
            <tr className="text-right">
              <th id={'tpv-pc'} className="text-left">Priemerná cena <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpv-pc'}>Bez PDM</UncontrolledTooltip>
              <Vypocet value={ cena.objem_m3 }
                       ...
                       cellsId={['fzp_v_spo_ns', 'fzp_v_spo_pdm', 'fzp_v_spo_m3']}
                       placement={'bottom'}
                       decimal={4}
                       class={fzp_v_pc_m3 + ' font-weight-bold'}
              />
              <Vypocet value={ cena.objem_mwh }
                       ...
                       cellsId={['fzp_v_spo_ns', 'fzp_v_spo_pdm', 'fzp_v_spo_mwh']}
                       placement={'bottom'}
                       decimal={4}
                       class={fzp_v_pc_mwh + ' font-weight-bold'}
              />
            </tr>
            </tbody>
          </Table>
