      ...
      <Card>
        ...
        <CardBody>
          <Table size={'sm'} bordered>
            ...
            <tr className="text-right">
              <th id={'tpz-pc'} className="text-left">Priemerná cena <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-pc'}>Bez PDM</UncontrolledTooltip>
              <Vypocet value={ cena.objem_m3 }
                       ...
                       cellsId={['fzp_z_spo_ns', 'fzp_z_spo_pdm', 'fzp_z_spo_m3']}
                       placement={'bottom'}
                       decimal={4}
              ...
              <Vypocet value={ cena.objem_mwh }
                       ...
                       cellsId={['fzp_z_spo_ns', 'fzp_z_spo_pdm', 'fzp_z_spo_mwh']}
                       placement={'bottom'}
                       decimal={4}
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  update: (e, table) => dispatch(updateZemnyPlynRequest(e, table))
})
