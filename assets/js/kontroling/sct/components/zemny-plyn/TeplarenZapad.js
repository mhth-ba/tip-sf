...
class TeplarenZapad extends React.Component {
  ...
  render() {
    ...
    const decimal = this.props.nastroje.decimal_fzptpz
    ...
    const {
      fzp_z_jan_m3, fzp_z_jan_mwh, fzp_z_jan_sopo, fzp_z_jan_fmso, fzp_z_jan_sopp, fzp_z_jan_fmsp,
      fzp_z_jan_sopd, fzp_z_jan_fmsd, fzp_z_jan_vsd, fzp_z_jan_dan_mwh, fzp_z_jan_dan_e, fzp_z_jan_pdm, fzp_z_jan_ns,

      fzp_z_feb_m3, fzp_z_feb_mwh, fzp_z_feb_sopo, fzp_z_feb_fmso, fzp_z_feb_sopp, fzp_z_feb_fmsp,
      fzp_z_feb_sopd, fzp_z_feb_fmsd, fzp_z_feb_vsd, fzp_z_feb_dan_mwh, fzp_z_feb_dan_e, fzp_z_feb_pdm, fzp_z_feb_ns,

      fzp_z_mar_m3, fzp_z_mar_mwh, fzp_z_mar_sopo, fzp_z_mar_fmso, fzp_z_mar_sopp, fzp_z_mar_fmsp,
      fzp_z_mar_sopd, fzp_z_mar_fmsd, fzp_z_mar_vsd, fzp_z_mar_dan_mwh, fzp_z_mar_dan_e, fzp_z_mar_pdm, fzp_z_mar_ns,

      fzp_z_apr_m3, fzp_z_apr_mwh, fzp_z_apr_sopo, fzp_z_apr_fmso, fzp_z_apr_sopp, fzp_z_apr_fmsp,
      fzp_z_apr_sopd, fzp_z_apr_fmsd, fzp_z_apr_vsd, fzp_z_apr_dan_mwh, fzp_z_apr_dan_e, fzp_z_apr_pdm, fzp_z_apr_ns,

      fzp_z_maj_m3, fzp_z_maj_mwh, fzp_z_maj_sopo, fzp_z_maj_fmso, fzp_z_maj_sopp, fzp_z_maj_fmsp,
      fzp_z_maj_sopd, fzp_z_maj_fmsd, fzp_z_maj_vsd, fzp_z_maj_dan_mwh, fzp_z_maj_dan_e, fzp_z_maj_pdm, fzp_z_maj_ns,

      fzp_z_jun_m3, fzp_z_jun_mwh, fzp_z_jun_sopo, fzp_z_jun_fmso, fzp_z_jun_sopp, fzp_z_jun_fmsp,
      fzp_z_jun_sopd, fzp_z_jun_fmsd, fzp_z_jun_vsd, fzp_z_jun_dan_mwh, fzp_z_jun_dan_e, fzp_z_jun_pdm, fzp_z_jun_ns,

      fzp_z_jul_m3, fzp_z_jul_mwh, fzp_z_jul_sopo, fzp_z_jul_fmso, fzp_z_jul_sopp, fzp_z_jul_fmsp,
      fzp_z_jul_sopd, fzp_z_jul_fmsd, fzp_z_jul_vsd, fzp_z_jul_dan_mwh, fzp_z_jul_dan_e, fzp_z_jul_pdm, fzp_z_jul_ns,

      fzp_z_aug_m3, fzp_z_aug_mwh, fzp_z_aug_sopo, fzp_z_aug_fmso, fzp_z_aug_sopp, fzp_z_aug_fmsp,
      fzp_z_aug_sopd, fzp_z_aug_fmsd, fzp_z_aug_vsd, fzp_z_aug_dan_mwh, fzp_z_aug_dan_e, fzp_z_aug_pdm, fzp_z_aug_ns,

      fzp_z_sep_m3, fzp_z_sep_mwh, fzp_z_sep_sopo, fzp_z_sep_fmso, fzp_z_sep_sopp, fzp_z_sep_fmsp,
      fzp_z_sep_sopd, fzp_z_sep_fmsd, fzp_z_sep_vsd, fzp_z_sep_dan_mwh, fzp_z_sep_dan_e, fzp_z_sep_pdm, fzp_z_sep_ns,

      fzp_z_okt_m3, fzp_z_okt_mwh, fzp_z_okt_sopo, fzp_z_okt_fmso, fzp_z_okt_sopp, fzp_z_okt_fmsp,
      fzp_z_okt_sopd, fzp_z_okt_fmsd, fzp_z_okt_vsd, fzp_z_okt_dan_mwh, fzp_z_okt_dan_e, fzp_z_okt_pdm, fzp_z_okt_ns,

      fzp_z_nov_m3, fzp_z_nov_mwh, fzp_z_nov_sopo, fzp_z_nov_fmso, fzp_z_nov_sopp, fzp_z_nov_fmsp,
      fzp_z_nov_sopd, fzp_z_nov_fmsd, fzp_z_nov_vsd, fzp_z_nov_dan_mwh, fzp_z_nov_dan_e, fzp_z_nov_pdm, fzp_z_nov_ns,

      fzp_z_dec_m3, fzp_z_dec_mwh, fzp_z_dec_sopo, fzp_z_dec_fmso, fzp_z_dec_sopp, fzp_z_dec_fmsp,
      fzp_z_dec_sopd, fzp_z_dec_fmsd, fzp_z_dec_vsd, fzp_z_dec_dan_mwh, fzp_z_dec_dan_e, fzp_z_dec_pdm, fzp_z_dec_ns,

      fzp_z_spo_m3, fzp_z_spo_mwh, fzp_z_spo_sopo, fzp_z_spo_fmso, fzp_z_spo_sopp, fzp_z_spo_fmsp,
      fzp_z_spo_sopd, fzp_z_spo_fmsd, fzp_z_spo_vsd, fzp_z_spo_dan_mwh, fzp_z_spo_dan_e, fzp_z_spo_pdm, fzp_z_spo_ns,
    ...
    return (
      <Card>
        <CardHeader className="bg-primary text-white">Tepláreň Západ</CardHeader>
        <CardBody>
          <Table size={'sm'} bordered>
            ...
            <tr className="text-center">
              ...
              <th rowSpan={2} style={{ maxWidth: '80px' }} id={'tpz-pdm'}>PDM <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-pdm'}>Prekročenie dohodnutých množstiev</UncontrolledTooltip>
              <th rowSpan={2}>Náklady spolu <Jednotka unit={'€'} /></th>
            </tr>
            <tr className="text-center">
              <th id={'tpz-sopo'}>SOP<sub>o</sub> <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-sopo'}>Sadzba za odobratý plyn</UncontrolledTooltip>
              <th id={'tpz-fmso'}>FMS<sub>o</sub> <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-fmso'}>Fixná mesačná sadzba</UncontrolledTooltip>
              <th id={'tpz-sopp'}>SOP<sub>p</sub> <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-sopp'}>Sadzba za odobratý plyn</UncontrolledTooltip>
              <th id={'tpz-fmsp'}>FMS<sub>p</sub> <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-fmsp'}>Fixná mesačná sadzba</UncontrolledTooltip>
              <th id={'tpz-sopd'}>SOP<sub>d</sub> <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-sopd'}>Sadzba za odobratý plyn</UncontrolledTooltip>
              <th id={'tpz-fmsd'}>FMS<sub>d</sub> <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-fmsd'}>Fixná mesačná sadzba</UncontrolledTooltip>
              <th id={'tpz-vsd'}>VS<sub>d</sub> <Jednotka unit={'€'} /></th>
              <UncontrolledTooltip target={'tpz-vsd'}>
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_jan} val={januar.objem_m3} col={'objem_m3'} class={fzp_z_jan_m3} />
              <Vstup {...vstup_jan} val={januar.objem_mwh} col={'objem_mwh'} class={fzp_z_jan_mwh} />
              <Vypocet value={ januar.sopo }
                       cisla={ <div>
                         <NumberFormat {...vypocetFormat} value={januar.objem_mwh} />
                         &nbsp;×&nbsp;
                         <NumberFormat {...vypocetFormat} value={jczpsopoz.hodnota} decimalScale={5} />
                       </div> }
                       popis={ <div>
                       ...
                       popoverId={'fzp_z_jan_sopo_pop'}
                       cellsId={['fzp_z_jan_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jan_sopo}
              />
              <Vstup {...vstup_jan} val={januar.fmso} col={'fmso'} class={fzp_z_jan_fmso} />
              <Vypocet value={ januar.sopp }
                       cisla={ <div>
                         <NumberFormat {...vypocetFormat} value={januar.objem_mwh} />
                         &nbsp;×&nbsp;
                         <NumberFormat {...vypocetFormat} value={jczpsoppz.hodnota} decimalScale={5} />
                       </div> }
                       popis={ <div>
                         <span className="polozka-1">MWh</span>
                         &nbsp;×&nbsp;
                       ...
                       popoverId={'fzp_z_jan_sopp_pop'}
                       cellsId={['fzp_z_jan_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jan_sopp}
              />
              <Vstup {...vstup_jan} val={januar.fmsp} col={'fmsp'} class={fzp_z_jan_fmsp} />
              <Vypocet value={ januar.sopd }
                       cisla={ <div>
                         <NumberFormat {...vypocetFormat} value={januar.objem_mwh} />
                         &nbsp;×&nbsp;
                         <NumberFormat {...vypocetFormat} value={jczpsopdz.hodnota} decimalScale={5} />
                       </div> }
                       popis={ <div>
                         <span className="polozka-1">MWh</span>
                         &nbsp;×&nbsp;
                       ...
                       popoverId={'fzp_z_jan_sopd_pop'}
                       cellsId={['fzp_z_jan_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jan_sopd}
              />
              <Vstup {...vstup_jan} val={januar.fmsd} col={'fmsd'} class={fzp_z_jan_fmsd} />
              <Vstup {...vstup_jan} val={januar.vsd} col={'vsd'} class={fzp_z_jan_vsd} />
              <Vstup {...vstup_jan} val={januar.dan_mwh} col={'dan_mwh'} class={fzp_z_jan_dan_mwh} />
              <Vstup {...vstup_jan} val={januar.dan_eur} col={'dan_eur'} class={fzp_z_jan_dan_e} />
              <Vstup {...vstup_jan} val={januar.pdm} col={'pdm'} class={fzp_z_jan_pdm} />
              <Vypocet value={ januar.naklady }
                       ...
                       popoverId={'fzp_z_jan_ns_pop'}
                       cellsId={[
                         'fzp_z_jan_sopo', 'fzp_z_jan_fmso', 'fzp_z_jan_sopp', 'fzp_z_jan_fmsp',
                         'fzp_z_jan_sopd', 'fzp_z_jan_fmsd', 'fzp_z_jan_vsd', 'fzp_z_jan_dan_e', 'fzp_z_jan_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jan_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_feb} val={februar.objem_m3} col={'objem_m3'} class={fzp_z_feb_m3} />
              <Vstup {...vstup_feb} val={februar.objem_mwh} col={'objem_mwh'} class={fzp_z_feb_mwh} />
              <Vypocet value={ februar.sopo }
                       ...
                       popoverId={'fzp_z_feb_sopo_pop'}
                       cellsId={['fzp_z_feb_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_feb_sopo}
              />
              <Vstup {...vstup_feb} val={februar.fmso} col={'fmso'} class={fzp_z_feb_fmso} />
              <Vypocet value={ februar.sopp }
                       ...
                       popoverId={'fzp_z_feb_sopp_pop'}
                       cellsId={['fzp_z_feb_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_feb_sopp}
              />
              <Vstup {...vstup_feb} val={februar.fmsp} col={'fmsp'} class={fzp_z_feb_fmsp} />
              <Vypocet value={ februar.sopd }
                       ...
                       popoverId={'fzp_z_feb_sopd_pop'}
                       cellsId={['fzp_z_feb_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_feb_sopd}
              />
              <Vstup {...vstup_feb} val={februar.fmsd} col={'fmsd'} class={fzp_z_feb_fmsd} />
              <Vstup {...vstup_feb} val={februar.vsd} col={'vsd'} class={fzp_z_feb_vsd} />
              <Vstup {...vstup_feb} val={februar.dan_mwh} col={'dan_mwh'} class={fzp_z_feb_dan_mwh} />
              <Vstup {...vstup_feb} val={februar.dan_eur} col={'dan_eur'} class={fzp_z_feb_dan_e} />
              <Vstup {...vstup_feb} val={februar.pdm} col={'pdm'} class={fzp_z_feb_pdm} />
              <Vypocet value={ februar.naklady }
                       ...
                       popoverId={'fzp_z_feb_ns_pop'}
                       cellsId={[
                         'fzp_z_feb_sopo', 'fzp_z_feb_fmso', 'fzp_z_feb_sopp', 'fzp_z_feb_fmsp',
                         'fzp_z_feb_sopd', 'fzp_z_feb_fmsd', 'fzp_z_feb_vsd', 'fzp_z_feb_dan_e', 'fzp_z_feb_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_feb_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_mar} val={marec.objem_m3} col={'objem_m3'} class={fzp_z_mar_m3} />
              <Vstup {...vstup_mar} val={marec.objem_mwh} col={'objem_mwh'} class={fzp_z_mar_mwh} />
              <Vypocet value={ marec.sopo }
                       ...
                       popoverId={'fzp_z_mar_sopo_pop'}
                       cellsId={['fzp_z_mar_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_mar_sopo}
              />
              <Vstup {...vstup_mar} val={marec.fmso} col={'fmso'} class={fzp_z_mar_fmso} />
              <Vypocet value={ marec.sopp }
                       ...
                       popoverId={'fzp_z_mar_sopp_pop'}
                       cellsId={['fzp_z_mar_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_mar_sopp}
              />
              <Vstup {...vstup_mar} val={marec.fmsp} col={'fmsp'} class={fzp_z_mar_fmsp} />
              <Vypocet value={ marec.sopd }
                       ...
                       popoverId={'fzp_z_mar_sopd_pop'}
                       cellsId={['fzp_z_mar_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_mar_sopd}
              />
              <Vstup {...vstup_mar} val={marec.fmsd} col={'fmsd'} class={fzp_z_mar_fmsd} />
              <Vstup {...vstup_mar} val={marec.vsd} col={'vsd'} class={fzp_z_mar_vsd} />
              <Vstup {...vstup_mar} val={marec.dan_mwh} col={'dan_mwh'} class={fzp_z_mar_dan_mwh} />
              <Vstup {...vstup_mar} val={marec.dan_eur} col={'dan_eur'} class={fzp_z_mar_dan_e} />
              <Vstup {...vstup_mar} val={marec.pdm} col={'pdm'} class={fzp_z_mar_pdm} />
              <Vypocet value={ marec.naklady }
                       ...
                       popoverId={'fzp_z_mar_ns_pop'}
                       cellsId={[
                         'fzp_z_mar_sopo', 'fzp_z_mar_fmso', 'fzp_z_mar_sopp', 'fzp_z_mar_fmsp',
                         'fzp_z_mar_sopd', 'fzp_z_mar_fmsd', 'fzp_z_mar_vsd', 'fzp_z_mar_dan_e', 'fzp_z_mar_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_mar_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_apr} val={april.objem_m3} col={'objem_m3'} class={fzp_z_apr_m3} />
              <Vstup {...vstup_apr} val={april.objem_mwh} col={'objem_mwh'} class={fzp_z_apr_mwh} />
              <Vypocet value={ april.sopo }
                       ...
                       popoverId={'fzp_z_apr_sopo_pop'}
                       cellsId={['fzp_z_apr_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_apr_sopo}
              />
              <Vstup {...vstup_apr} val={april.fmso} col={'fmso'} class={fzp_z_apr_fmso} />
              <Vypocet value={ april.sopp }
                       ...
                       popoverId={'fzp_z_apr_sopp_pop'}
                       cellsId={['fzp_z_apr_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_apr_sopp}
              />
              <Vstup {...vstup_apr} val={april.fmsp} col={'fmsp'} class={fzp_z_apr_fmsp} />
              <Vypocet value={ april.sopd }
                       ...
                       popoverId={'fzp_z_apr_sopd_pop'}
                       cellsId={['fzp_z_apr_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_apr_sopd}
              />
              <Vstup {...vstup_apr} val={april.fmsd} col={'fmsd'} class={fzp_z_apr_fmsd} />
              <Vstup {...vstup_apr} val={april.vsd} col={'vsd'} class={fzp_z_apr_vsd} />
              <Vstup {...vstup_apr} val={april.dan_mwh} col={'dan_mwh'} class={fzp_z_apr_dan_mwh} />
              <Vstup {...vstup_apr} val={april.dan_eur} col={'dan_eur'} class={fzp_z_apr_dan_e} />
              <Vstup {...vstup_apr} val={april.pdm} col={'pdm'} class={fzp_z_apr_pdm} />
              <Vypocet value={ april.naklady }
                       ...
                       popoverId={'fzp_z_apr_ns_pop'}
                       cellsId={[
                         'fzp_z_apr_sopo', 'fzp_z_apr_fmso', 'fzp_z_apr_sopp', 'fzp_z_apr_fmsp',
                         'fzp_z_apr_sopd', 'fzp_z_apr_fmsd', 'fzp_z_apr_vsd', 'fzp_z_apr_dan_e', 'fzp_z_apr_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_apr_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_maj} val={maj.objem_m3} col={'objem_m3'} class={fzp_z_maj_m3} />
              <Vstup {...vstup_maj} val={maj.objem_mwh} col={'objem_mwh'} class={fzp_z_maj_mwh} />
              <Vypocet value={ maj.sopo }
                       ...
                       popoverId={'fzp_z_maj_sopo_pop'}
                       cellsId={['fzp_z_maj_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_maj_sopo}
              />
              <Vstup {...vstup_maj} val={maj.fmso} col={'fmso'} class={fzp_z_maj_fmso} />
              <Vypocet value={ maj.sopp }
                       ...
                       popoverId={'fzp_z_maj_sopp_pop'}
                       cellsId={['fzp_z_maj_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_maj_sopp}
              />
              <Vstup {...vstup_maj} val={maj.fmsp} col={'fmsp'} class={fzp_z_maj_fmsp} />
              <Vypocet value={ maj.sopd }
                       ...
                       popoverId={'fzp_z_maj_sopd_pop'}
                       cellsId={['fzp_z_maj_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_maj_sopd}
              />
              <Vstup {...vstup_maj} val={maj.fmsd} col={'fmsd'} class={fzp_z_maj_fmsd} />
              <Vstup {...vstup_maj} val={maj.vsd} col={'vsd'} class={fzp_z_maj_vsd} />
              <Vstup {...vstup_maj} val={maj.dan_mwh} col={'dan_mwh'} class={fzp_z_maj_dan_mwh} />
              <Vstup {...vstup_maj} val={maj.dan_eur} col={'dan_eur'} class={fzp_z_maj_dan_e} />
              <Vstup {...vstup_maj} val={maj.pdm} col={'pdm'} class={fzp_z_maj_pdm} />
              <Vypocet value={ maj.naklady }
                       ...
                       popoverId={'fzp_z_maj_ns_pop'}
                       cellsId={[
                         'fzp_z_maj_sopo', 'fzp_z_maj_fmso', 'fzp_z_maj_sopp', 'fzp_z_maj_fmsp',
                         'fzp_z_maj_sopd', 'fzp_z_maj_fmsd', 'fzp_z_maj_vsd', 'fzp_z_maj_dan_e', 'fzp_z_maj_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_maj_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_jun} val={jun.objem_m3} col={'objem_m3'} class={fzp_z_jun_m3} />
              <Vstup {...vstup_jun} val={jun.objem_mwh} col={'objem_mwh'} class={fzp_z_jun_mwh} />
              <Vypocet value={ jun.sopo }
                       ...
                       popoverId={'fzp_z_jun_sopo_pop'}
                       cellsId={['fzp_z_jun_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jun_sopo}
              />
              <Vstup {...vstup_jun} val={jun.fmso} col={'fmso'} class={fzp_z_jun_fmso} />
              <Vypocet value={ jun.sopp }
                       ...
                       popoverId={'fzp_z_jun_sopp_pop'}
                       cellsId={['fzp_z_jun_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jun_sopp}
              />
              <Vstup {...vstup_jun} val={jun.fmsp} col={'fmsp'} class={fzp_z_jun_fmsp} />
              <Vypocet value={ jun.sopd }
                       ...
                       popoverId={'fzp_z_jun_sopd_pop'}
                       cellsId={['fzp_z_jun_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jun_sopd}
              />
              <Vstup {...vstup_jun} val={jun.fmsd} col={'fmsd'} class={fzp_z_jun_fmsd} />
              <Vstup {...vstup_jun} val={jun.vsd} col={'vsd'} class={fzp_z_jun_vsd} />
              <Vstup {...vstup_jun} val={jun.dan_mwh} col={'dan_mwh'} class={fzp_z_jun_dan_mwh} />
              <Vstup {...vstup_jun} val={jun.dan_eur} col={'dan_eur'} class={fzp_z_jun_dan_e} />
              <Vstup {...vstup_jun} val={jun.pdm} col={'pdm'} class={fzp_z_jun_pdm} />
              <Vypocet value={ jun.naklady }
                       ...
                       popoverId={'fzp_z_jun_ns_pop'}
                       cellsId={[
                         'fzp_z_jun_sopo', 'fzp_z_jun_fmso', 'fzp_z_jun_sopp', 'fzp_z_jun_fmsp',
                         'fzp_z_jun_sopd', 'fzp_z_jun_fmsd', 'fzp_z_jun_vsd', 'fzp_z_jun_dan_e', 'fzp_z_jun_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jun_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_jul} val={jul.objem_m3} col={'objem_m3'} class={fzp_z_jul_m3} />
              <Vstup {...vstup_jul} val={jul.objem_mwh} col={'objem_mwh'} class={fzp_z_jul_mwh} />
              <Vypocet value={ jul.sopo }
                       ...
                       popoverId={'fzp_z_jul_sopo_pop'}
                       cellsId={['fzp_z_jul_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jul_sopo}
              />
              <Vstup {...vstup_jul} val={jul.fmso} col={'fmso'} class={fzp_z_jul_fmso} />
              <Vypocet value={ jul.sopp }
                       ...
                       popoverId={'fzp_z_jul_sopp_pop'}
                       cellsId={['fzp_z_jul_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jul_sopp}
              />
              <Vstup {...vstup_jul} val={jul.fmsp} col={'fmsp'} class={fzp_z_jul_fmsp} />
              <Vypocet value={ jul.sopd }
                       ...
                       popoverId={'fzp_z_jul_sopd_pop'}
                       cellsId={['fzp_z_jul_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jul_sopd}
              />
              <Vstup {...vstup_jul} val={jul.fmsd} col={'fmsd'} class={fzp_z_jul_fmsd} />
              <Vstup {...vstup_jul} val={jul.vsd} col={'vsd'} class={fzp_z_jul_vsd} />
              <Vstup {...vstup_jul} val={jul.dan_mwh} col={'dan_mwh'} class={fzp_z_jul_dan_mwh} />
              <Vstup {...vstup_jul} val={jul.dan_eur} col={'dan_eur'} class={fzp_z_jul_dan_e} />
              <Vstup {...vstup_jul} val={jul.pdm} col={'pdm'} class={fzp_z_jul_pdm} />
              <Vypocet value={ jul.naklady }
                       ...
                       popoverId={'fzp_z_jul_ns_pop'}
                       cellsId={[
                         'fzp_z_jul_sopo', 'fzp_z_jul_fmso', 'fzp_z_jul_sopp', 'fzp_z_jul_fmsp',
                         'fzp_z_jul_sopd', 'fzp_z_jul_fmsd', 'fzp_z_jul_vsd', 'fzp_z_jul_dan_e', 'fzp_z_jul_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_jul_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_aug} val={august.objem_m3} col={'objem_m3'} class={fzp_z_aug_m3} />
              <Vstup {...vstup_aug} val={august.objem_mwh} col={'objem_mwh'} class={fzp_z_aug_mwh} />
              <Vypocet value={ august.sopo }
                       ...
                       popoverId={'fzp_z_aug_sopo_pop'}
                       cellsId={['fzp_z_aug_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_aug_sopo}
              />
              <Vstup {...vstup_aug} val={august.fmso} col={'fmso'} class={fzp_z_aug_fmso} />
              <Vypocet value={ august.sopp }
                       ...
                       popoverId={'fzp_z_aug_sopp_pop'}
                       cellsId={['fzp_z_aug_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_aug_sopp}
              />
              <Vstup {...vstup_aug} val={august.fmsp} col={'fmsp'} class={fzp_z_aug_fmsp} />
              <Vypocet value={ august.sopd }
                       ...
                       popoverId={'fzp_z_aug_sopd_pop'}
                       cellsId={['fzp_z_aug_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_aug_sopd}
              />
              <Vstup {...vstup_aug} val={august.fmsd} col={'fmsd'} class={fzp_z_aug_fmsd} />
              <Vstup {...vstup_aug} val={august.vsd} col={'vsd'} class={fzp_z_aug_vsd} />
              <Vstup {...vstup_aug} val={august.dan_mwh} col={'dan_mwh'} class={fzp_z_aug_dan_mwh} />
              <Vstup {...vstup_aug} val={august.dan_eur} col={'dan_eur'} class={fzp_z_aug_dan_e} />
              <Vstup {...vstup_aug} val={august.pdm} col={'pdm'} class={fzp_z_aug_pdm} />
              <Vypocet value={ august.naklady }
                       ...
                       popoverId={'fzp_z_aug_ns_pop'}
                       cellsId={[
                         'fzp_z_aug_sopo', 'fzp_z_aug_fmso', 'fzp_z_aug_sopp', 'fzp_z_aug_fmsp',
                         'fzp_z_aug_sopd', 'fzp_z_aug_fmsd', 'fzp_z_aug_vsd', 'fzp_z_aug_dan_e', 'fzp_z_aug_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_aug_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_sep} val={september.objem_m3} col={'objem_m3'} class={fzp_z_sep_m3} />
              <Vstup {...vstup_sep} val={september.objem_mwh} col={'objem_mwh'} class={fzp_z_sep_mwh} />
              <Vypocet value={ september.sopo }
                       ...
                       popoverId={'fzp_z_sep_sopo_pop'}
                       cellsId={['fzp_z_sep_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_sep_sopo}
              />
              <Vstup {...vstup_sep} val={september.fmso} col={'fmso'} class={fzp_z_sep_fmso} />
              <Vypocet value={ september.sopp }
                       ...
                       popoverId={'fzp_z_sep_sopp_pop'}
                       cellsId={['fzp_z_sep_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_sep_sopp}
              />
              <Vstup {...vstup_sep} val={september.fmsp} col={'fmsp'} class={fzp_z_sep_fmsp} />
              <Vypocet value={ september.sopd }
                       ...
                       popoverId={'fzp_z_sep_sopd_pop'}
                       cellsId={['fzp_z_sep_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_sep_sopd}
              />
              <Vstup {...vstup_sep} val={september.fmsd} col={'fmsd'} class={fzp_z_sep_fmsd} />
              <Vstup {...vstup_sep} val={september.vsd} col={'vsd'} class={fzp_z_sep_vsd} />
              <Vstup {...vstup_sep} val={september.dan_mwh} col={'dan_mwh'} class={fzp_z_sep_dan_mwh} />
              <Vstup {...vstup_sep} val={september.dan_eur} col={'dan_eur'} class={fzp_z_sep_dan_e} />
              <Vstup {...vstup_sep} val={september.pdm} col={'pdm'} class={fzp_z_sep_pdm} />
              <Vypocet value={ september.naklady }
                       ...
                       popoverId={'fzp_z_sep_ns_pop'}
                       cellsId={[
                         'fzp_z_sep_sopo', 'fzp_z_sep_fmso', 'fzp_z_sep_sopp', 'fzp_z_sep_fmsp',
                         'fzp_z_sep_sopd', 'fzp_z_sep_fmsd', 'fzp_z_sep_vsd', 'fzp_z_sep_dan_e', 'fzp_z_sep_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_sep_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_okt} val={oktober.objem_m3} col={'objem_m3'} class={fzp_z_okt_m3} />
              <Vstup {...vstup_okt} val={oktober.objem_mwh} col={'objem_mwh'} class={fzp_z_okt_mwh} />
              <Vypocet value={ oktober.sopo }
                       ...
                       popoverId={'fzp_z_okt_sopo_pop'}
                       cellsId={['fzp_z_okt_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_okt_sopo}
              />
              <Vstup {...vstup_okt} val={oktober.fmso} col={'fmso'} class={fzp_z_okt_fmso} />
              <Vypocet value={ oktober.sopp }
                       ...
                       popoverId={'fzp_z_okt_sopp_pop'}
                       cellsId={['fzp_z_okt_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_okt_sopp}
              />
              <Vstup {...vstup_okt} val={oktober.fmsp} col={'fmsp'} class={fzp_z_okt_fmsp} />
              <Vypocet value={ oktober.sopd }
                       ...
                       popoverId={'fzp_z_okt_sopd_pop'}
                       cellsId={['fzp_z_okt_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_okt_sopd}
              />
              <Vstup {...vstup_okt} val={oktober.fmsd} col={'fmsd'} class={fzp_z_okt_fmsd} />
              <Vstup {...vstup_okt} val={oktober.vsd} col={'vsd'} class={fzp_z_okt_vsd} />
              <Vstup {...vstup_okt} val={oktober.dan_mwh} col={'dan_mwh'} class={fzp_z_okt_dan_mwh} />
              <Vstup {...vstup_okt} val={oktober.dan_eur} col={'dan_eur'} class={fzp_z_okt_dan_e} />
              <Vstup {...vstup_okt} val={oktober.pdm} col={'pdm'} class={fzp_z_okt_pdm} />
              <Vypocet value={ oktober.naklady }
                       ...
                       popoverId={'fzp_z_okt_ns_pop'}
                       cellsId={[
                         'fzp_z_okt_sopo', 'fzp_z_okt_fmso', 'fzp_z_okt_sopp', 'fzp_z_okt_fmsp',
                         'fzp_z_okt_sopd', 'fzp_z_okt_fmsd', 'fzp_z_okt_vsd', 'fzp_z_okt_dan_e', 'fzp_z_okt_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_okt_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_nov} val={november.objem_m3} col={'objem_m3'} class={fzp_z_nov_m3} />
              <Vstup {...vstup_nov} val={november.objem_mwh} col={'objem_mwh'} class={fzp_z_nov_mwh} />
              <Vypocet value={ november.sopo }
                       ...
                       popoverId={'fzp_z_nov_sopo_pop'}
                       cellsId={['fzp_z_nov_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_nov_sopo}
              />
              <Vstup {...vstup_nov} val={november.fmso} col={'fmso'} class={fzp_z_nov_fmso} />
              <Vypocet value={ november.sopp }
                       ...
                       popoverId={'fzp_z_nov_sopp_pop'}
                       cellsId={['fzp_z_nov_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_nov_sopp}
              />
              <Vstup {...vstup_nov} val={november.fmsp} col={'fmsp'} class={fzp_z_nov_fmsp} />
              <Vypocet value={ november.sopd }
                       ...
                       popoverId={'fzp_z_nov_sopd_pop'}
                       cellsId={['fzp_z_nov_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_nov_sopd}
              />
              <Vstup {...vstup_nov} val={november.fmsd} col={'fmsd'} class={fzp_z_nov_fmsd} />
              <Vstup {...vstup_nov} val={november.vsd} col={'vsd'} class={fzp_z_nov_vsd} />
              <Vstup {...vstup_nov} val={november.dan_mwh} col={'dan_mwh'} class={fzp_z_nov_dan_mwh} />
              <Vstup {...vstup_nov} val={november.dan_eur} col={'dan_eur'} class={fzp_z_nov_dan_e} />
              <Vstup {...vstup_nov} val={november.pdm} col={'pdm'} class={fzp_z_nov_pdm} />
              <Vypocet value={ november.naklady }
                       ...
                       popoverId={'fzp_z_nov_ns_pop'}
                       cellsId={[
                         'fzp_z_nov_sopo', 'fzp_z_nov_fmso', 'fzp_z_nov_sopp', 'fzp_z_nov_fmsp',
                         'fzp_z_nov_sopd', 'fzp_z_nov_fmsd', 'fzp_z_nov_vsd', 'fzp_z_nov_dan_e', 'fzp_z_nov_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_nov_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vstup {...vstup_dec} val={december.objem_m3} col={'objem_m3'} class={fzp_z_dec_m3} />
              <Vstup {...vstup_dec} val={december.objem_mwh} col={'objem_mwh'} class={fzp_z_dec_mwh} />
              <Vypocet value={ december.sopo }
                       ...
                       popoverId={'fzp_z_dec_sopo_pop'}
                       cellsId={['fzp_z_dec_mwh', 'fzp_k_jczpsopoz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_dec_sopo}
              />
              <Vstup {...vstup_dec} val={december.fmso} col={'fmso'} class={fzp_z_dec_fmso} />
              <Vypocet value={ december.sopp }
                       ...
                       popoverId={'fzp_z_dec_sopp_pop'}
                       cellsId={['fzp_z_dec_mwh', 'fzp_k_jczpsoppz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_dec_sopp}
              />
              <Vstup {...vstup_dec} val={december.fmsp} col={'fmsp'} class={fzp_z_dec_fmsp} />
              <Vypocet value={ december.sopd }
                       ...
                       popoverId={'fzp_z_dec_sopd_pop'}
                       cellsId={['fzp_z_dec_mwh', 'fzp_k_jczpsopdz']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_dec_sopd}
              />
              <Vstup {...vstup_dec} val={december.fmsd} col={'fmsd'} class={fzp_z_dec_fmsd} />
              <Vstup {...vstup_dec} val={december.vsd} col={'vsd'} class={fzp_z_dec_vsd} />
              <Vstup {...vstup_dec} val={december.dan_mwh} col={'dan_mwh'} class={fzp_z_dec_dan_mwh} />
              <Vstup {...vstup_dec} val={december.dan_eur} col={'dan_eur'} class={fzp_z_dec_dan_e} />
              <Vstup {...vstup_dec} val={december.pdm} col={'pdm'} class={fzp_z_dec_pdm} />
              <Vypocet value={ december.naklady }
                       ...
                       popoverId={'fzp_z_dec_ns_pop'}
                       cellsId={[
                         'fzp_z_dec_sopo', 'fzp_z_dec_fmso', 'fzp_z_dec_sopp', 'fzp_z_dec_fmsp',
                         'fzp_z_dec_sopd', 'fzp_z_dec_fmsd', 'fzp_z_dec_vsd', 'fzp_z_dec_dan_e', 'fzp_z_dec_pdm']}
                       placement={'top'}
                       decimal={decimal}
                       class={fzp_z_dec_ns}
              />
            ...
            <tr className="text-right">
              ...
              <Vypocet value={ spolu.objem_m3 }
                       ...
                       popoverId={'fzp_z_spo_m3_pop'}
                       cellsId={[
                         'fzp_z_jan_m3', 'fzp_z_feb_m3', 'fzp_z_mar_m3', 'fzp_z_apr_m3',
                         'fzp_z_maj_m3', 'fzp_z_jun_m3', 'fzp_z_jul_m3', 'fzp_z_aug_m3',
                         'fzp_z_sep_m3', 'fzp_z_okt_m3', 'fzp_z_nov_m3', 'fzp_z_dec_m3']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_m3 + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.objem_mwh }
                       ...
                       popoverId={'fzp_z_spo_mwh_pop'}
                       cellsId={[
                         'fzp_z_jan_mwh', 'fzp_z_feb_mwh', 'fzp_z_mar_mwh', 'fzp_z_apr_mwh',
                         'fzp_z_maj_mwh', 'fzp_z_jun_mwh', 'fzp_z_jul_mwh', 'fzp_z_aug_mwh',
                         'fzp_z_sep_mwh', 'fzp_z_okt_mwh', 'fzp_z_nov_mwh', 'fzp_z_dec_mwh']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_mwh + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.sopo }
                       ...
                       popoverId={'fzp_z_spo_sopo_pop'}
                       cellsId={[
                         'fzp_z_jan_sopo', 'fzp_z_feb_sopo', 'fzp_z_mar_sopo', 'fzp_z_apr_sopo',
                         'fzp_z_maj_sopo', 'fzp_z_jun_sopo', 'fzp_z_jul_sopo', 'fzp_z_aug_sopo',
                         'fzp_z_sep_sopo', 'fzp_z_okt_sopo', 'fzp_z_nov_sopo', 'fzp_z_dec_sopo']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_sopo + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.fmso }
                       ...
                       popoverId={'fzp_z_spo_fmso_pop'}
                       cellsId={[
                         'fzp_z_jan_fmso', 'fzp_z_feb_fmso', 'fzp_z_mar_fmso', 'fzp_z_apr_fmso',
                         'fzp_z_maj_fmso', 'fzp_z_jun_fmso', 'fzp_z_jul_fmso', 'fzp_z_aug_fmso',
                         'fzp_z_sep_fmso', 'fzp_z_okt_fmso', 'fzp_z_nov_fmso', 'fzp_z_dec_fmso']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_fmso + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.sopp }
                       ...
                       popoverId={'fzp_z_spo_sopp_pop'}
                       cellsId={[
                         'fzp_z_jan_sopp', 'fzp_z_feb_sopp', 'fzp_z_mar_sopp', 'fzp_z_apr_sopp',
                         'fzp_z_maj_sopp', 'fzp_z_jun_sopp', 'fzp_z_jul_sopp', 'fzp_z_aug_sopp',
                         'fzp_z_sep_sopp', 'fzp_z_okt_sopp', 'fzp_z_nov_sopp', 'fzp_z_dec_sopp']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_sopp + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.fmsp }
                       ...
                       popoverId={'fzp_z_spo_fmsp_pop'}
                       cellsId={[
                         'fzp_z_jan_fmsp', 'fzp_z_feb_fmsp', 'fzp_z_mar_fmsp', 'fzp_z_apr_fmsp',
                         'fzp_z_maj_fmsp', 'fzp_z_jun_fmsp', 'fzp_z_jul_fmsp', 'fzp_z_aug_fmsp',
                         'fzp_z_sep_fmsp', 'fzp_z_okt_fmsp', 'fzp_z_nov_fmsp', 'fzp_z_dec_fmsp']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_fmsp + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.sopd }
                       ...
                       popoverId={'fzp_z_spo_sopd_pop'}
                       cellsId={[
                         'fzp_z_jan_sopd', 'fzp_z_feb_sopd', 'fzp_z_mar_sopd', 'fzp_z_apr_sopd',
                         'fzp_z_maj_sopd', 'fzp_z_jun_sopd', 'fzp_z_jul_sopd', 'fzp_z_aug_sopd',
                         'fzp_z_sep_sopd', 'fzp_z_okt_sopd', 'fzp_z_nov_sopd', 'fzp_z_dec_sopd']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_sopd + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.fmsd }
                       ...
                       popoverId={'fzp_z_spo_fmsd_pop'}
                       cellsId={[
                         'fzp_z_jan_fmsd', 'fzp_z_feb_fmsd', 'fzp_z_mar_fmsd', 'fzp_z_apr_fmsd',
                         'fzp_z_maj_fmsd', 'fzp_z_jun_fmsd', 'fzp_z_jul_fmsd', 'fzp_z_aug_fmsd',
                         'fzp_z_sep_fmsd', 'fzp_z_okt_fmsd', 'fzp_z_nov_fmsd', 'fzp_z_dec_fmsd']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_fmsd + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.vsd }
                       ...
                       popoverId={'fzp_z_spo_vsd_pop'}
                       cellsId={[
                         'fzp_z_jan_vsd', 'fzp_z_feb_vsd', 'fzp_z_mar_vsd', 'fzp_z_apr_vsd',
                         'fzp_z_maj_vsd', 'fzp_z_jun_vsd', 'fzp_z_jul_vsd', 'fzp_z_aug_vsd',
                         'fzp_z_sep_vsd', 'fzp_z_okt_vsd', 'fzp_z_nov_vsd', 'fzp_z_dec_vsd']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_vsd + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.dan_mwh }
                       ...
                       popoverId={'fzp_z_spo_dan_mwh_pop'}
                       cellsId={[
                         'fzp_z_jan_dan_mwh', 'fzp_z_feb_dan_mwh', 'fzp_z_mar_dan_mwh', 'fzp_z_apr_dan_mwh',
                         'fzp_z_maj_dan_mwh', 'fzp_z_jun_dan_mwh', 'fzp_z_jul_dan_mwh', 'fzp_z_aug_dan_mwh',
                         'fzp_z_sep_dan_mwh', 'fzp_z_okt_dan_mwh', 'fzp_z_nov_dan_mwh', 'fzp_z_dec_dan_mwh']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_dan_mwh + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.dan_eur }
                       ...
                       popoverId={'fzp_z_spo_dan_e_pop'}
                       cellsId={[
                         'fzp_z_jan_dan_e', 'fzp_z_feb_dan_e', 'fzp_z_mar_dan_e', 'fzp_z_apr_dan_e',
                         'fzp_z_maj_dan_e', 'fzp_z_jun_dan_e', 'fzp_z_jul_dan_e', 'fzp_z_aug_dan_e',
                         'fzp_z_sep_dan_e', 'fzp_z_okt_dan_e', 'fzp_z_nov_dan_e', 'fzp_z_dec_dan_e']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_dan_e + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.pdm }
                       ...
                       popoverId={'fzp_z_spo_pdm_pop'}
                       cellsId={[
                         'fzp_z_jan_pdm', 'fzp_z_feb_pdm', 'fzp_z_mar_pdm', 'fzp_z_apr_pdm',
                         'fzp_z_maj_pdm', 'fzp_z_jun_pdm', 'fzp_z_jul_pdm', 'fzp_z_aug_pdm',
                         'fzp_z_sep_pdm', 'fzp_z_okt_pdm', 'fzp_z_nov_pdm', 'fzp_z_dec_pdm']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_pdm + ' font-weight-bold'}
              />
              ...
              <Vypocet value={ spolu.naklady }
                       ...
                       popoverId={'fzp_z_spo_ns_pop'}
                       cellsId={[
                         'fzp_z_jan_ns', 'fzp_z_feb_ns', 'fzp_z_mar_ns', 'fzp_z_apr_ns',
                         'fzp_z_maj_ns', 'fzp_z_jun_ns', 'fzp_z_jul_ns', 'fzp_z_aug_ns',
                         'fzp_z_sep_ns', 'fzp_z_okt_ns', 'fzp_z_nov_ns', 'fzp_z_dec_ns']}
                       placement={'bottom'}
                       decimal={decimal}
                       class={fzp_z_spo_ns + ' font-weight-bold'}
              />
            </tr>
            <tr className="text-right">
              <th id={'tpz-pc'} className="text-left">Priemerná cena</th>
              <UncontrolledTooltip target={'tpz-pc'}>Vrátane PDM</UncontrolledTooltip>
              <Vypocet value={ cena.objem_m3 }
                       ...
                       popoverId={'fzp_z_pc_m3_pop'}
                       cellsId={['fzp_z_spo_ns', 'fzp_z_spo_m3']}
                       placement={'bottom'}
                       decimal={4}
                       class={fzp_z_pc_m3 + ' font-weight-bold'}
              />
              <Vypocet value={ cena.objem_mwh }
                       ...
                       popoverId={'fzp_z_pc_mwh_pop'}
                       cellsId={['fzp_z_spo_ns', 'fzp_z_spo_mwh']}
                       placement={'bottom'}
                       decimal={4}
                       class={fzp_z_pc_mwh + ' font-weight-bold'}
              />
            </tr>
            ...
            <tr className="text-right">
              ...
              <Vypocet value={ vn }
                       ...
                       popoverId={'fzp_z_vn_pop'}
                       cellsId={['fzp_z_spo_sopo', 'fzp_z_spo_sopp', 'fzp_z_spo_sopd', 'fzp_z_spo_dan_e', 'fzp_z_spo_pdm']}
                       placement={'right'}
                       decimal={decimal}
            ...
            <tr className="text-right">
              ...
              <Vypocet value={ fn }
                       ...
                       popoverId={'fzp_z_fn_pop'}
                       cellsId={['fzp_z_spo_fmso', 'fzp_z_spo_fmsp', 'fzp_z_spo_fmsd', 'fzp_z_spo_vsd']}
                       placement={'right'}
                       decimal={decimal}
                       class={'font-weight-bold'}
              />
