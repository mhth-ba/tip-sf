...
class NormativneMnozstvoPKBezPrimaru extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
    ...
    const bp = nm.pk_bez_primaru

    const decimal = this.props.nastroje.decimal_pbnmzppkbp
    ...
    return (
      <Card>
        <CardHeader className="bg-primary text-white">
          Normatívne množstvo zemného plynu - Plynové kotolne (bez primárneho rozvodu)
        </CardHeader>
        <CardBody>
