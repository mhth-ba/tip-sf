...
export default (state = initState, action) => {
  switch (action.type) {
    ...
    case TYPES.CREATE_POZNAMKA_REQUEST:
      return { ...state, loading: true, error: null }

    case TYPES.CREATE_POZNAMKA_SUCCESS:
    ...
    case TYPES.CREATE_POZNAMKA_ERROR:
      return { ...state, loading: false, error: action.data }

    case TYPES.UPDATE_POZNAMKA_REQUEST:
      return { ...state, loading: true, error: null }

    case TYPES.UPDATE_POZNAMKA_SUCCESS:
      return {
        ...state,
        loading: false,
    ...
    case TYPES.DELETE_POZNAMKA_SUCCESS:
    ...
    case TYPES.DELETE_POZNAMKA_ERROR:
      return { ...state, loading: false, error: action.data }
