...
// Read-only view component for PraceNaOSTDispecing
class PraceNaOSTDispecingReadOnly extends React.Component {
    ...
    return (
      <Card>
        <CardHeader className="bg-primary text-white d-flex justify-content-between align-items-center">
          <span>Práce na OST - dispečing a poruchová služba</span>
...
export default connect(mapStateToProps)(PraceNaOSTDispecingReadOnly)
