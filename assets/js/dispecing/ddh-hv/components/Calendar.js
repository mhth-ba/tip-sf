...
import {
  ...
  fetchDenneDispecerskeHlasenieHVRequest
} from '../actions'
...
class Calendar extends React.Component {
  ...
  componentDidMount() {
    // Load permissions and dispeceri
    ...
    this.props.fetchDenneDispecerskeHlasenieHV(dateString)
  }
...
const mapDispatchToProps = dispatch => ({
  ...
  fetchDenneDispecerskeHlasenieHV: date => dispatch(fetchDenneDispecerskeHlasenieHVRequest(date))
})
